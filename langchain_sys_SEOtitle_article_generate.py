...
prompt = ChatPromptTemplate.from_messages([
    ("system", "You are a content manager with extensive SEO knowledge. Your task is to write an article with about 100 words based on a given title, and create a SEO title for the article you wrte."),
    ("user", "{input}"),
])
